...
const thumbConfig: Record<string, { bg: string; text: string; icon: LucideIcon }> = {
  ...
  "prompt-as-design-artifact": { bg: "bg-primary-fixed", text: "text-on-primary-fixed", icon: Sparkles },
  "why-design-systems-fail":   { bg: "bg-secondary-fixed", text: "text-on-secondary-fixed", icon: Boxes },
  "designing-for-decisions":   { bg: "bg-tertiary-fixed", text: "text-on-tertiary-fixed", icon: Compass },
}
...
const readMin: Record<string, number> = {
  ...
  "engineering-depth":  5,
  "value-realization":  6,
  "prompt-as-design-artifact": 8,
  "why-design-systems-fail":   8,
  "designing-for-decisions":   8,
}
