...
import { EvidencePackBillingClient } from "./billing-client"

export const metadata: Metadata = {
  title: "EvidencePack Billing",
  alternates: { canonical: "https://cpdeol.com/evidencepack/app/billing" },
}

export default async function EvidencePackBillingPage() {
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="rounded-2xl bg-surface-container-low p-8 shadow-editorial md:p-10">
            ...
            <p className="mt-4 font-sans text-sm font-normal leading-[1.7] text-on-surface-variant md:text-base md:leading-[1.75]">
              Billing is available to pilot users only.
            </p>
            <div className="mt-6">
              <Link
    ...
    <PageShell>
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        <header className="rounded-2xl bg-surface-container-low p-8 shadow-editorial md:p-10">
          ...
          <h1 className="font-display mt-4 text-3xl font-bold tracking-tight text-on-surface md:text-4xl">Billing</h1>
          <p className="mt-4 font-sans text-sm font-normal leading-[1.7] text-on-surface-variant md:text-base md:leading-[1.75]">
            Signed in as <span className="font-semibold text-on-surface">{session.email}</span>.
          </p>
        </header>

        <EvidencePackBillingClient />
      </div>
    </PageShell>
  )
}
